...
Original file is located at
    https://colab.research.google.com/drive/1S8wKv7LOs9odZA0fJ_WjBxK4_P2shQpX
...
input_test /= 255.0
print(input_train.shape, target_train.shape, input_test.shape, target_test.shape, len(emnist_labels))

import tensorflow as tf
from tensorflow.keras.utils import to_categorical
target_train = to_categorical(target_train, len(emnist_labels))
target_test = to_categorical(target_test, len(emnist_labels))
...
def emnist_train(model):
    ...
    model.fit(X_train, y_train, validation_data=(X_test, y_test), callbacks=[learning_rate_reduction], batch_size=64, epochs=3)
...
if __name__ == "__main__":
    ...
    model = emnist_model()
    emnist_train(model)
    model.save('letters_second.h5')

    model = keras.models.load_model('letters_second.h5')
    s_out = img_to_str(model, "test.png")
    print(s_out)
